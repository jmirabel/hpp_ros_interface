...
class Supervision(Plugin):
    ...
    def __init__(self, context):
        ...
        step_by_step_spin_box.setValue(rospy.get_param(Supervision.StepByStepParam))
        # step_by_step_spin_box.connect (self.setStepByStepParam)
        step_by_step_spin_box.valueChanged.connect (lambda val: rospy.set_param(Supervision.StepByStepParam, val))
    ...
    def publishState (self):
        try:
            ...
            publish_state = rospy.ServiceProxy (Supervision.PublishStateService, EmptySrv)
            publish_state()
